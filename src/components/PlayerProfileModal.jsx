...
export default function PlayerProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-[#2D2319]/60 backdrop-blur-[1px] select-none modal-backdrop-animate">
      
      {/* Modal Dialog Box */}
      <div className="w-full max-w-xl bg-[#FDF8EE] border-2 border-[#2D2319] rounded-2xl shadow-[6px_6px_0px_#2D2319] overflow-hidden flex flex-col max-h-[90vh] modal-window-animate font-sans">
