  ...
  return (
    <div className="w-full max-w-[460px] mx-auto select-none relative flex items-center justify-center pointer-events-none py-1">
      ...
      >
        ...
        {showLeft && (
          <g id="left-hand">
            {/* Left Hand Solid Base Fill */}
            <path
              d="M 38 175 L 38 150 C 38 128 20 108 20 85 C 20 62 21 42 26 34 C 30 24 44 24 48 34 C 51 44 52 70 52 86 C 52 66 53 38 58 26 C 62 16 76 16 80 26 C 83 38 84 66 84 86 C 84 62 85 28 90 18 C 94 8 108 8 112 18 C 115 28 116 62 116 86 C 116 66 117 38 122 26 C 126 16 140 16 144 26 C 147 38 144 75 140 96 C 138 108 142 118 150 122 C 158 126 168 126 174 130 C 180 134 180 144 172 148 C 160 154 136 150 116 152 L 116 175 L 38 175 Z"
              fill="#ffffff"
            />
