...
## 2. No Personal Data Collection or Tracking
- We **do not** collect personal identifiers such as your real name, email address, phone number, location data, or IP address.
- We **do not** use third-party analytics trackers, behavioral cookies, advertising identifiers, or telemetry aggregators.
- We **do not** sell, rent, or monetize your data.

---

## 3. Microsoft Store Distribution
When installed through the Microsoft Store, application downloads and installations are managed through Microsoft Partner Center and the Microsoft Store infrastructure subject to [Microsoft's Privacy Statement](https://privacy.microsoft.com/).

---

## 4. Updates & Changes
If this privacy policy is updated, the revised version will be included in subsequent application releases and published on our official repository.
